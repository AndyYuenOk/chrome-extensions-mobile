...
## 如果应用或网页打不开，打开速度慢，使用不正常，主要还是 DNS 问题

---

# 开屏广告必须死

日常使用中，最不能忍受的就是开屏广告，需要等待广告展示完成才能进入，开屏广告必须死

这里再推荐一款广告跳过软件 https://github.com/gkd-kit/gkd

AdGuard 是基于请求规则过滤广告的，gkd 是基于订阅规则无障碍点击跳过广告的，二者并不冲突，搭配使用有奇效
